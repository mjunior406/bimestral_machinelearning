# 🎮 Anti-Cheat Inteligente com DBSCAN em JavaScript
...
1. Clica no botão verde no topo da página que diz **"Code"** e depois na aba **"Codespaces"**.
2. Clica em **"Create codespace on main"**.
3. O GitHub vai abrir um terminal virtual no teu navegador.
4. No terminal lá em baixo, digita os seguintes comandos:
